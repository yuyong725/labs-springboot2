package cn.javadog.labs.springboot2.datasource.dynamic.mybatis.config;
 ...
 */
@Configuration
@MapperScan(basePackages = "cn.javadog.labs.springboot2.datasource.dynamic.mybatis.mapper.orders", sqlSessionTemplateRef = "ordersSqlSessionTemplate")
public class MyBatisOrdersConfig {
    ...
    public SqlSessionFactory sqlSessionFactory() throws Exception {
        ...
        // 设置 entity 所在包
        bean.setTypeAliasesPackage("cn.javadog.labs.springboot2.datasource.dynamic.mybatis.dataobject");
        // 设置 config 路径
