...
import cn.javadog.labs.springboot2.async.simple.service.DemoService;
...
@SpringBootTest(classes = AsyncSimpleApplication.class)
public class DemoServiceTest {
    ...
    public void task04() throws ExecutionException, InterruptedException {
        ...
        // 增加成功的回调 + 失败的回调
        execute01Result.addCallback(result -> logger.info("[onSuccess][result: {}]", result), ex -> logger.info("[onFailure][发生异常]", ex));
        // 增加成功和失败的统一回调
